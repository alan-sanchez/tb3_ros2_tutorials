...
Before you get started with these tutorials, I recommend you complete the [Quick Start Guide](hhttps://docs.robotis.com/docs/systems/turtlebot3/quick_start_guide/pc_setup) offered by [ROBOTIS](https://emanual.robotis.com/). I found it to be very helpful when setting everything up. For this project, I utilized the instructions for installing Humble on the turtlebot. 
